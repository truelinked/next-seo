(function (global, factory) {
  ...
  var _excluded$8 = ['type', 'keyOverride', 'address', 'contactPoints'];
  ...
  var _excluded$4 = ['type', 'keyOverride', 'courseName', 'provider'];
  ...
  var _excluded$3 = ['type', 'id', 'keyOverride', 'aggregateRating'];
  ...
  var _excluded$2 = ['keyOverride', 'reviewedBy'];
  ...
  var _excluded$1 = ['type', 'keyOverride'];
