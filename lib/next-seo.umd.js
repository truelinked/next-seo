(function (global, factory) {
  ...
  var _excluded = ['type', 'keyOverride', 'scriptKey', 'scriptId'];
  ...
  var _excluded$1 = ['reviewRating', 'author', 'publisher'];
  ...
  var _excluded$2 = ['thumbnailUrls', 'hasPart', 'watchCount', 'publication'];
  ...
  var _excluded$7 = ['type', 'keyOverride', 'mainEntity'],
  ...
  var _excluded$8 = ['type', 'keyOverride', 'breadcrumb'];
  ...
  var _excluded$9 = ['type', 'keyOverride', 'potentialActions'];
  ...
  var buildPerformer = function buildPerformer(performer) {
    return (
      '\n  {\n    "@type": "' +
      (performer.type ? performer.type : 'Person') +
      '",\n    "name": "' +
      performer.name +
      '"\n    "sameAs": "' +
      performer.sameAs +
  ...
  var buildWorksPerformed = function buildWorksPerformed(work) {
    return (
      '\n  {    \n    "@type":"CreativeWork",\n    "name": "' +
      work.name +
      '",\n    "creator":{\n       "@type":"Person",\n       "name":"' +
  ...
  var buildComposer = function buildComposer(composer) {
    return (
      '\n  {\n    "@type": "' +
      (composer.type ? composer.type : 'Person') +
      '",\n    "name": "' +
      composer.name +
      '",\n    "sameAs": "' +
      composer.sameAs +
          ...
          (Array.isArray(works)
            ? '[' +
              works.map(function (work) {
                return '' + buildWorksPerformed(work);
              }) +
              ']'
  ...
  var _excluded$b = ['type', 'keyOverride', 'contactPoint'];
  ...
  var _excluded$g = ['type', 'keyOverride'];
  ...
  var _excluded$i = ['type', 'keyOverride', 'address', 'contactPoints'];
  ...
  var _excluded$k = ['type', 'keyOverride'];
  ...
  var _excluded$l = ['type', 'keyOverride'];
  ...
  var _excluded$m = ['type', 'keyOverride', 'courseName', 'provider'];
  ...
  var _excluded$n = ['type', 'id', 'keyOverride', 'aggregateRating'];
  ...
  var _excluded$o = ['keyOverride', 'reviewedBy'];
  ...
  var _excluded$p = ['type', 'keyOverride'];
