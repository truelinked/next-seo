(function (global, factory) {
  ...
  var escapeJsonLd = function escapeJsonLd(input) {
    try {
    ...
    return Array.isArray(authorName)
      ? '[' +
          authorName.map(function (name) {
            return '{"@type": "Person","name": "' + escapeJsonLd(name) + '"}';
          }) +
          ']'
  ...
  var ArticleJsonLd = function ArticleJsonLd(_ref) {
    ...
    var jslonld =
      ...
      ',\n    "publisher": {\n      "@type": "Organization",\n      "name": "' +
      escapeJsonLd(publisherName) +
      '",\n      "logo": {\n        "@type": "ImageObject",\n        "url": "' +
      publisherLogo +
      '"\n      }\n    },\n    "description": "' +
      escapeJsonLd(description) +
      '"\n  }';
    return React__default['default'].createElement(
      Head__default['default'],
      null,
    ...
    var jslonld =
      ...
      itemListElements.map(function (itemListElement) {
        return (
          ...
          ',\n        "item": {\n          "@id": "' +
          escapeJsonLd(itemListElement.item) +
          '",\n          "name": "' +
          escapeJsonLd(itemListElement.name) +
          '"\n        }\n      }'
        );
      }) +
      '\n     ]\n  }';
  ...
  var buildQuestions = function buildQuestions(mainEntity) {
    return (
      ...
      mainEntity.map(function (question) {
        return (
          '{\n      "@type": "Question",\n      "name": "' +
          escapeJsonLd(question.questionName) +
          '",\n      "acceptedAnswer": {\n        "@type": "Answer",\n        "text": "' +
          escapeJsonLd(question.acceptedAnswerText) +
          '"\n      }\n  }'
        );
      })
    );
  ...
  var JobPostingJsonLd = function JobPostingJsonLd(_ref) {
    ...
    var jslonld =
      ...
      '\n    "hiringOrganization" : {\n      "@type" : "Organization",\n      "name" : "' +
      escapeJsonLd(hiringOrganization.name) +
      '",\n      "sameAs" : "' +
      escapeJsonLd(hiringOrganization.sameAs) +
      '"\n      ' +
      ...
      (jobLocation
        ? '"jobLocation": {\n      "@type": "Place",\n      "address": {\n        "@type": "PostalAddress",\n        "addressLocality": "' +
          escapeJsonLd(jobLocation.addressLocality) +
          '",\n        "addressRegion": "' +
          escapeJsonLd(jobLocation.addressRegion) +
          '",\n        "postalCode" : "' +
          escapeJsonLd(jobLocation.postalCode) +
          '",\n        "streetAddress" : "' +
          escapeJsonLd(jobLocation.streetAddress) +
          '",\n        "addressCountry" : "' +
          escapeJsonLd(jobLocation.addressCountry) +
          '"\n          }\n      },'
        : '') +
      '\n    ' +
      (applicantLocationRequirements
        ? ' "applicantLocationRequirements": {\n        "@type": "Country",\n        "name": "' +
          escapeJsonLd(applicantLocationRequirements) +
          '"\n    },'
        : '') +
      '\n    ' +
      (jobLocationType
      ...
      '\n    ' +
      (validThrough
        ? '"validThrough": "' + escapeJsonLd(validThrough) + '",'
        : '') +
      '\n    "title": "' +
      escapeJsonLd(title) +
      '"\n  }';
  ...
  var buildAddress = function (address) {
    return (
      '\n  "address": {\n    "@type": "PostalAddress",\n    "streetAddress": "' +
      escapeJsonLd(address.streetAddress) +
      '",\n    "addressLocality": "' +
      escapeJsonLd(address.addressLocality) +
      '",\n    ' +
      (address.addressRegion
        ? '"addressRegion": "' + escapeJsonLd(address.addressRegion) + '",'
        : '') +
      '\n    "postalCode": "' +
      escapeJsonLd(address.postalCode) +
      '",\n    "addressCountry": "' +
      escapeJsonLd(address.addressCountry) +
      '"\n  },\n'
    );
  };
  ...
  var buildOffers = function buildOffers(offers) {
    return (
      '\n  {\n    "@type": "Offer",\n    "priceCurrency": "' +
      escapeJsonLd(offers.priceCurrency) +
      '",\n    ' +
      ...
      (offers.seller
        ? '\n      "seller": {\n      "@type": "Organization",\n      "name": "' +
          escapeJsonLd(offers.seller.name) +
          '"\n    },\n    '
        : '') +
      '\n    "price": "' +
      escapeJsonLd(offers.price) +
      '"\n  }\n'
    );
  };
  ...
  var buildAggregateOffer = function buildAggregateOffer(offer) {
    return (
      '\n  {\n    "@type": "AggregateOffer",\n    "priceCurrency": "' +
      escapeJsonLd(offer.priceCurrency) +
      '",\n    ' +
      (offer.highPrice
        ? '"highPrice": "' + escapeJsonLd(offer.highPrice) + '",'
        : '') +
      '\n    ' +
      (offer.offerCount
  ...
  var NewsArticleJsonLd = function NewsArticleJsonLd(_ref) {
    ...
    var jslonld =
      ...
      '\n     ],\n    "articleSection":"' +
      escapeJsonLd(section) +
      '",\n    "keywords": "' +
      escapeJsonLd(keywords) +
      '",\n    "datePublished": "' +
      datePublished +
      '",\n    "dateCreated": "' +
  ...
  var buildLocation = function buildLocation(location) {
    try {
      var data =
        ...
        '\n      ' +
        (location.type
          ? '"@type": "' + escapeJsonLd(location.type) + '"'
          : '') +
        '\n      ' +
        (location.url ? ',"url": "' + location.url + '"' : '') +
        '\n      ' +
        (location.sameAs
          ? ',"sameAs": "' + escapeJsonLd(location.sameAs) + '"'
          : '') +
        '\n      ' +
        (location.name
          ? '",name": "' + escapeJsonLd(location.name) + '"'
          : '') +
        '\n    }\n  ';
  ...
  var buildPerformer = function buildPerformer(performer) {
    return (
      '\n  {\n    "@type": "Person",\n    "name": "' +
      escapeJsonLd(performer.name) +
      '"\n  }\n'
    );
  };

  var buildComposer = function buildComposer(composer) {
    return (
      '\n  {\n    "@type": "Person",\n    "name": "' +
      escapeJsonLd(composer.name) +
      '"\n  }\n'
    );
  };

  var buildOrganization = function buildOrganization(organizer) {
    return (
      '\n  {\n    "@type": "Organization",\n    "name": "' +
      escapeJsonLd(organizer.name) +
      '",\n    ' +
  ...
  var EventJsonLd = function EventJsonLd(_ref) {
    var keyOverride = _ref.keyOverride,
      ...
      composers = _ref.composers,
      organizers = _ref.organizers;
    var locationJSONLD = buildLocation(location);
    var jslonld =
      '{\n    "@context": "https://schema.org",\n    "@type": "' +
          ...
          (Array.isArray(organizers)
            ? '[' +
              organizers.map(function (organizer) {
                return '' + buildOrganization(organizer);
              }) +
              ']'
  ...
  var buildVideo = function (video, context) {
    ...
    return (
      ...
      '\n      "@type": "VideoObject",\n      "name": "' +
      escapeJsonLd(video.name) +
      '",\n      "description": "' +
      escapeJsonLd(video.description) +
      '",\n      "thumbnailUrl": [\n          ' +
      video.thumbnailUrls
  ...
  var buildQuestions$1 = function buildQuestions(mainEntity) {
    return (
      '{\n        "@type": "Question",\n        "name": "' +
      escapeJsonLd(mainEntity.name) +
      '",\n        ' +
      (mainEntity.text
        ? '"text": "' + escapeJsonLd(mainEntity.text) + '",'
        : '') +
      '\n        "answerCount": ' +
      ...
      (mainEntity.author
        ? '"author": {\n          "@type": "Person",\n          "name": "' +
          escapeJsonLd(mainEntity.author.name) +
          '"\n        },'
        : '') +
      '\n        ' +
      (mainEntity.acceptedAnswer
        ? '"acceptedAnswer": {\n          "@type": "Answer",\n          "text": "' +
          escapeJsonLd(mainEntity.acceptedAnswer.text) +
          '",\n          ' +
          ...
          (mainEntity.acceptedAnswer.author
            ? '"author": {\n            "@type": "Person",\n            "name": "' +
              escapeJsonLd(mainEntity.acceptedAnswer.author.name) +
              '"\n          }'
            : '') +
          '\n        },'
        : '') +
        ...
        ? '"suggestedAnswer": [' +
          mainEntity.suggestedAnswer.map(function (suggested) {
            return (
              ...
              (suggested.author
                ? '"author": {\n                        "@type": "Person",\n                        "name": "' +
                  escapeJsonLd(suggested.author.name) +
                  '"\n                    }'
                : '') +
              '\n        }'
            );
  ...
  var buildInstruction = function buildInstruction(instruction) {
    return (
      '{\n  "@type": "HowToStep",\n  "name": "' +
      escapeJsonLd(instruction.name) +
      '",\n  "text": "' +
      escapeJsonLd(instruction.text) +
      '",\n  "url": "' +
      instruction.url +
      '",\n  "image": "' +
      instruction.image +
