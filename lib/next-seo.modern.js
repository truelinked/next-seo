...
const _excluded$8 = ['type', 'keyOverride', 'address', 'contactPoints'];
...
const _excluded$4 = ['type', 'keyOverride', 'courseName', 'provider'];
...
const _excluded$3 = ['type', 'id', 'keyOverride', 'aggregateRating'];
...
const _excluded$2 = ['keyOverride', 'reviewedBy'];
...
const _excluded$1 = ['type', 'keyOverride'];
